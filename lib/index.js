...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["@mfelibs/common-vue-cmnt"] = factory();
	else
		root["@mfelibs/common-vue-cmnt"] = factory();
...
module.exports = __webpack_require__(192)() ? Symbol : __webpack_require__(193);
...
var assign        = __webpack_require__(31)
  ...
  , isCallable    = __webpack_require__(188)
...
var _undefined = __webpack_require__(59)(); // Support ES3 engines
...
var arrayFilter = __webpack_require__(124),
    stubArray = __webpack_require__(48);
...
var clear    = __webpack_require__(58)
  ...
  , autoBind = __webpack_require__(200)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_touch__ = __webpack_require__(68);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_throttle__ = __webpack_require__(70);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep__ = __webpack_require__(77);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_cmnt_css__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_cmnt_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__css_cmnt_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__normalCard_vue__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__quickReplyCard_vue__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__loadmoreCard_vue__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__fakePubCard_vue__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__formatter__ = __webpack_require__(154);
//
//
//
//
...
//
//
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_1_vue_touch___default.a,{name:"v-touch"});var cardTypeMap={normalCard:"normal-card",quickReplyCard:"quick-card",loadmoreCard:"loadmore-card",fakePubCard:"fake-pub-card"};var elasticDistance=50;/* harmony default export */ __webpack_exports__["a"] = ({props:{topLayer:{type:Array},secLayer:{type:Object},userInfo:{type:Object},agreedList:{type:Array},// loadmoreThreshold: {
//   type: Number
// },
// autoScroll: {},
config:{type:Object}},data:function data(){return{cardTypeMap:Object.assign({},cardTypeMap),cmntArray:[],topLoadmoreLock:false,noMoreCMNT:false,fakePublishList:[],loadmoreThreshold:0};},created:function created(){var config=this.config||{};if(config.autoScroll==undefined){this.localAutoScroll=1;}else{this.localAutoScroll=config.autoScroll;}if(config.loadmoreThreshold==undefined){this.loadmoreThreshold=300;}else{this.loadmoreThreshold=config.loadmoreThreshold;}// 存储数据
this.localSecObject=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(this.secLayer);this.localTopArray=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(this.topLayer);this.localUserInfo=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(this.userInfo)||{};this.localAgreedList=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(this.agreedList)||[];this._initSpecData();// 获取格式化后的渲染数据
this.cmntArray=Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["b" /* formatAllData */])(this.localTopArray,this.localSecObject,this.localUserInfo,this.localAgreedList);// 加载更多解锁
this.topLoadmoreLock=false;// 已无更多数据
this.noMoreCMNT=false;},mounted:function mounted(){if(this.loadmoreThreshold){this._initEventListener();}},beforeDestroy:function beforeDestroy(){this._lodashWrapper&&window.removeEventListener("scroll",this._lodashWrapper);},methods:{doPraise:function doPraise(info){info=info||{data:{},status:0};// 存储点赞信息
// info.data.mid && this.praiseSet.add(info.data.mid);
// 点赞动画
info.data.__doPraise=1;// 更新点赞数量 更新点赞背景色
if(!info.status){this.localAgreedList.push(info.data.mid);info.data.agree=info.data.agree+1;info.data.__showAgree=Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["e" /* showNumFormat */])(info.data.agree);info.data.__hot=parseInt(info.data.agree,10)>49;// 热门评论 特殊背景颜色样式
}this.$emit("cmnt-do-praise",info);},doReply:function doReply(info){this.$emit("cmnt-do-reply",info);},doReport:function doReport(info){this.$emit("cmnt-do-report",info);},doShowall:function doShowall(info){info.data.__showEllipsis=0;this.$emit("cmnt-do-showall",info);},doImgclick:function doImgclick(info){this.$emit("cmnt-do-imgclick",info);},doSecLoadmore:function doSecLoadmore(info){var mid=info.data.mid;var page=this.localSecObject[mid]&&this.localSecObject[mid].__page||1;info.page=page;info.data.__showLoading=1;// 添加loading
this.localSecObject[mid].__loading=1;// 保存状态
this.$emit("cmnt-do-sec-loadmore",info,this._secLoadmore);},doTopLoadmore:function doTopLoadmore(){if(!this.topLoadmoreLock){var emitData={data:{},page:this.topLayerPage};this.topLoadmoreLock=true;this.$emit("cmnt-do-top-loadmore",emitData,this._topLoadmore);}},showReport:function showReport(info){this._closeAllReport();info.data.__showReport=1;},closeReport:function closeReport(info){this._closeAllReport();},hideReport:function hideReport(e){var target=e.target||e.srcElement;if(!target.className.match("post_return_reply")){this._closeAllReport();}},refreshAllCMNT:function refreshAllCMNT(data){var _this=this;var topLayer=data.topLayer,secLayer=data.secLayer,userInfo=data.userInfo;// 清除假发布
this.fakePublishList=[];// 剔除所有旧数据 点赞状态
this.cmntArray.forEach(function(cmnt){cmnt.__doPraise=0;});this.localSecObject=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(secLayer);this.localTopArray=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(topLayer);this._initSpecData();userInfo&&(this.localUserInfo=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(userInfo));// 添加点赞状态
// 如果直接在格式化时处理 在列表切换时 切换前后都有点赞状态的节点没动效 显示效果不统一
setTimeout(function(){_this.cmntArray=Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["b" /* formatAllData */])(_this.localTopArray,_this.localSecObject,_this.localUserInfo,_this.localAgreedList);},10);},updateUserInfo:function updateUserInfo(userInfo){userInfo=userInfo||{};this.localUserInfo=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(userInfo);this.cmntArray=Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["b" /* formatAllData */])(this.localTopArray,this.localSecObject,this.localUserInfo,this.localAgreedList);},fakePublish:function fakePublish(data){// 是否需要更新已点赞信息
// 对评论的假发布会默认更新，因为本身就会更新真实评论列表。
// 对文章的假发布会利用此变量进行检测 避免额外运算
// let needUpdateAgreedList = 0;
// 理论上只有发生评论时才可能有发生用户信息变更（未登录 => 登录）
if(data.userInfo){this.localUserInfo=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(data.userInfo);}// 理论上只有发生评论时才可能有点赞信息变更（未登录 => 登录）
// if (data.agreedList) {
...
//   }
// }
if(!this.localUserInfo.nick){// 无用户信息 返回
console.log("Err， 没有登录用户信息， 不进行假发布");return;}if(!data.fakeData){console.log("Err， 没有假发布数据， 不进行假发布");return;}if(data.target&&data.target.mid){// 对评论的假发布
var localSecFakeData=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(data.fakeData);localSecFakeData.parent_uid=data.target.uid;localSecFakeData.parent_nick=data.target.nick;var localSecObjectMid=void 0;if(data.target.thread){// 对二级评论的假发布
localSecObjectMid=data.target.thread;if(!this.localSecObject[localSecObjectMid]){// 异常情况 本身没有二级评论 还是有对二级评论的假发布
console.log("Error, 对二级评论的假发布，却本身没有二级评论");return;}}else{// 对一级评论的假发布
localSecObjectMid=data.target.mid;if(!this.localSecObject[localSecObjectMid]){// 原本就没有评论 添加一条假的回复
this.localSecObject[data.target.mid]={};}}this.localSecObject[localSecObjectMid]["fakeList"]=this.localSecObject[localSecObjectMid]["fakeList"]||[];this.localSecObject[localSecObjectMid]["fakeList"].unshift(localSecFakeData);this.cmntArray=Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["b" /* formatAllData */])(this.localTopArray,this.localSecObject,this.localUserInfo,this.localAgreedList);var childrenNums=this.$children.length;var targetEl=void 0;for(var i=0;i<childrenNums;i++){if(localSecObjectMid===this.$children[i].data.mid){targetEl=this.$children[i].$el;break;}}this.localAutoScroll&&targetEl&&this._pageScroll(targetEl.offsetTop-elasticDistance);}else{// 对文章的假发布
var localFakeData=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(data.fakeData);Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["c" /* formatFakeData */])(localFakeData,this.localUserInfo);this.fakePublishList.unshift(localFakeData);// // 如果需更新点赞信息
...
//   );
// }
this.localAutoScroll&&this._pageScroll(this.$el.offsetTop-elasticDistance);}},/**
     * 初始化特殊数据
     * 二级评论：加载更多页码 & 加载更多状态
     * 一级评论：加载更多页码
     */_initSpecData:function _initSpecData(){for(var mid in this.localSecObject){Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["a" /* addSecSpecData */])(this.localSecObject[mid]);}this.topLayerPage=2;// 默认加载更多从第二屏开始
},_closeAllReport:function _closeAllReport(){this.cmntArray.forEach(function(cmnt){cmnt.__showReport=0;});},_secLoadmore:function _secLoadmore(data){var secLayer=data.secLayer,userInfo=data.userInfo;if(userInfo){this.localUserInfo=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(userInfo);}this.localSecObject=Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["d" /* mergeSecData */])(this.localSecObject,secLayer,1);this.cmntArray=Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["b" /* formatAllData */])(this.localTopArray,this.localSecObject,this.localUserInfo,this.localAgreedList);},_topLoadmore:function _topLoadmore(data){var topLayer=data.topLayer,secLayer=data.secLayer,userInfo=data.userInfo;if(userInfo){this.localUserInfo=__WEBPACK_IMPORTED_MODULE_3_lodash_cloneDeep___default()(userInfo);}if(topLayer&&topLayer.length){this.topLoadmoreLock=false;// 允许加载更多
this.topLayerPage++;// 更新页码
this.localTopArray=this.localTopArray.concat(topLayer);this.localSecObject=Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["d" /* mergeSecData */])(this.localSecObject,secLayer);this.cmntArray=Object(__WEBPACK_IMPORTED_MODULE_9__formatter__["b" /* formatAllData */])(this.localTopArray,this.localSecObject,this.localUserInfo,this.localAgreedList);}else{this.noMoreCMNT=true;// 已无更多评论
this.topLoadmoreLock=true;// 禁止加载更多
}},_initEventListener:function _initEventListener(){this._lodashWrapper=__WEBPACK_IMPORTED_MODULE_2_lodash_throttle___default()(this._checkLoadmore,300);window.addEventListener("scroll",this._lodashWrapper);},_checkLoadmore:function _checkLoadmore(){// 视区高
var clientH=document.documentElement.clientHeight||window.innerHeight;// 文档高
var offsetH=document.documentElement.scrollHeight||document.body.offsetHeight;// 滚动高
var scrollT=document.documentElement.scrollTop||document.body.scrollTop;if(scrollT+clientH+this.loadmoreThreshold<offsetH){return;}this.doTopLoadmore();},_pageScroll:function _pageScroll(y){var to=y;var step=void 0;var times=0;var scrollTop=document.documentElement.scrollTop||document.body.scrollTop;window.requestAnimationFrame=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame;var distance=to-scrollTop;var absDistance=Math.abs(distance);if(absDistance<10000){step=distance/20;}else if(absDistance<20000){step=distance/40;}else{step=distance/50;}function move(){times++;scrollTop+=step;window.scrollTo(0,scrollTop);if(step>0&&scrollTop<=to-3||step<0&&scrollTop>=to+3){requestAnimationFrame(move);}}requestAnimationFrame(move);}},updated:function updated(){// 添加点赞状态
// 如果直接在格式化时处理 在列表切换时 切换前后都有点赞状态的节点没动效 显示效果不统一
// console.log('updated');
// setTimeout(() => {
...
//   });
// }, 10);
},components:{NormalCard:__WEBPACK_IMPORTED_MODULE_5__normalCard_vue__["a" /* default */],QuickCard:__WEBPACK_IMPORTED_MODULE_6__quickReplyCard_vue__["a" /* default */],LoadmoreCard:__WEBPACK_IMPORTED_MODULE_7__loadmoreCard_vue__["a" /* default */],FakePubCard:__WEBPACK_IMPORTED_MODULE_8__fakePubCard_vue__["a" /* default */]}});
...
/* harmony default export */ __webpack_exports__["a"] = ({props:{data:{type:Object,required:true},config:{type:Object}},created:function created(){// console.log("normal card created", this.data);
},methods:{doPraise:function doPraise(){var status=this.data.__doPraise?1:0;// 之前的点赞状态 1已点过 0没点过
this.$emit("do-praise",{data:this.data,status:status});},doReply:function doReply(){this.$emit("do-reply",{data:this.data});},doReport:function doReport(){this.$emit("do-report",{data:this.data});},doShowall:function doShowall(){this.$emit("do-showall",{data:this.data});},doImgclick:function doImgclick(){this.$emit("do-imgclick",{data:this.data});},showReport:function showReport(e){this.$emit("show-report",{data:this.data});},closeReport:function closeReport(){this.$emit("close-report",{data:this.data});}}});
...
//
//
var defaultImg="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjYAAAAAIAAeIhvDMAAAAASUVORK5CYII=";// TODO: +V 信息  ic_v_blue ic_v_yellow
/* harmony default export */ __webpack_exports__["a"] = ({props:{data:{type:Object,required:true},config:{type:Object}},created:function created(){// console.log("quick card created", this.data);
},computed:{quickInfo:function quickInfo(){var temp=Object.assign({},this.data);temp.userImg=temp.__loginUserImg||defaultImg;return temp;}},methods:{doReply:function doReply(){this.$emit("do-reply",{data:this.data});}}});
...
//
//
/* harmony default export */ __webpack_exports__["a"] = ({props:{data:{type:Object,required:true},config:{type:Object}},created:function created(){// console.log("create");
this.showCMNTName=this.config.showName||'评论';},methods:{doSecLoadmore:function doSecLoadmore(){this.$emit("do-sec-loadmore",{data:this.data});}}});
...
//
//
var defaultImg="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjYAAAAAIAAeIhvDMAAAAASUVORK5CYII=";/* harmony default export */ __webpack_exports__["a"] = ({props:{data:{type:Object,required:true},config:{type:Object}},created:function created(){this.data.profile_img=this.data.profile_img||defaultImg;this.fakePublishText=this.config.fakePublishText;},methods:{// doPraise() {
...
// }
doShowall:function doShowall(){this.$emit("do-showall",{data:this.data});},doImgclick:function doImgclick(){this.$emit("do-imgclick",{data:this.data});}}});
...
var isIterable = __webpack_require__(196);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_cmntList_vue__ = __webpack_require__(66);
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__components_cmntList_vue__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_babelrc_false_presets_babel_preset_react_app_plugins_transform_decorators_legacy_compact_true_cacheDirectory_false_highlightCode_true_node_modules_vue_loader_lib_selector_type_script_index_0_cmntList_vue__ = __webpack_require__(34);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4c5f5b72_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_cmntList_vue__ = __webpack_require__(212);
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_babelrc_false_presets_babel_preset_react_app_plugins_transform_decorators_legacy_compact_true_cacheDirectory_false_highlightCode_true_node_modules_vue_loader_lib_selector_type_script_index_0_cmntList_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4c5f5b72_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_cmntList_vue__["a" /* default */],
...
var Stack = __webpack_require__(79),
    ...
    isArray = __webpack_require__(18),
    isBuffer = __webpack_require__(43),
    isMap = __webpack_require__(141),
    isObject = __webpack_require__(3),
    isSet = __webpack_require__(143),
...
var baseIsMap = __webpack_require__(142),
    baseUnary = __webpack_require__(25),
    nodeUtil = __webpack_require__(26);
...
var baseIsSet = __webpack_require__(144),
    baseUnary = __webpack_require__(25),
    nodeUtil = __webpack_require__(26);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_babelrc_false_presets_babel_preset_react_app_plugins_transform_decorators_legacy_compact_true_cacheDirectory_false_highlightCode_true_node_modules_vue_loader_lib_selector_type_script_index_0_normalCard_vue__ = __webpack_require__(53);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_28586df5_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_normalCard_vue__ = __webpack_require__(147);
var normalizeComponent = __webpack_require__(10)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_babelrc_false_presets_babel_preset_react_app_plugins_transform_decorators_legacy_compact_true_cacheDirectory_false_highlightCode_true_node_modules_vue_loader_lib_selector_type_script_index_0_normalCard_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_28586df5_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_normalCard_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"post_return_row",class:{'no_line': !_vm.data.__hasLine}},[_c('div',{staticClass:"post_return_row_l"},[_c('figure',{staticClass:"post_return_row_img",class:{'mini':_vm.data.__showMini, 'my':_vm.data.__isMy}},[_c('img',{staticClass:"img_width i_bg",attrs:{"src":_vm.data.profile_img}}),_vm._v(" "),_c('i',{staticClass:"post_return_row_ic"})])]),_vm._v(" "),_c('aside',{staticClass:"post_return_row_r"},[_c('div',{staticClass:"post_return_com",class:{'sp': _vm.data.__hot}},[_c('a',{staticClass:"post_return_report",class:{'hide': !_vm.data.__showReport},attrs:{"href":"javascript:void(0)"},on:{"click":_vm.doReport}},[_c('i',{staticClass:"icon_police"}),_vm._v(" "),_c('span',{staticClass:"post_return_report_txt"},[_vm._v("举报")])]),_vm._v(" "),_c('h2',{staticClass:"post_return_com_tit"},[_c('span',{staticClass:"post_return_com_tit_id"},[_vm._v(_vm._s(_vm.data.nick))]),_vm._v(" "),(_vm.data.tag)?_c('mark',{staticClass:"post_return_com_tit_sign"},[_vm._v(_vm._s(_vm.data.tag))]):_vm._e()]),_vm._v(" "),_c('address',{staticClass:"post_return_add"},[_c('span',{staticClass:"post_return_add_txt"},[_vm._v(_vm._s(_vm.data.area))]),_vm._v(" "),_c('time',{attrs:{"calss":"post_return_add_t"}},[_vm._v(_vm._s(_vm.data.__showTime))])]),_vm._v(" "),_c('v-touch',{class:{'post_return_show': !_vm.data.__showEllipsis},attrs:{"tag":"div","options":{domEvents:true},"press-options":{ time	: 800}},on:{"press":function($event){_vm.showReport($event)},"tap":function($event){_vm.closeReport($event)}}},[_c('p',{staticClass:"post_return_reply",domProps:{"innerHTML":_vm._s(_vm.data.__showContent)}}),_vm._v(" "),_c('a',{staticClass:"post_return_reply_more",on:{"click":_vm.doShowall}},[_vm._v("展开全部")]),_vm._v(" "),(_vm.data.comment_imgs && _vm.data.comment_imgs[0])?_c('img',{staticClass:"post_return_img i_bg",attrs:{"src":_vm.data.comment_imgs[0]},on:{"click":_vm.doImgclick}}):_vm._e()]),_vm._v(" "),_c('nav',{staticClass:"post_return_fun"},[_c('a',{staticClass:"post_return_fun_link",class:{ active: _vm.data.__doPraise},attrs:{"href":"javascript:void(0)"},on:{"click":_vm.doPraise}},[_vm._m(0),_vm._v(" "),_c('span',{staticClass:"post_return_fun_txt"},[_c('span',[_vm._v(_vm._s(_vm.data.__showAgree))]),_vm._v("赞")])]),_vm._v(" "),_c('a',{staticClass:"post_return_fun_link",attrs:{"href":"javascript:void(0)"},on:{"click":_vm.doReply}},[_c('i',{staticClass:"ic_com_reply post_return_fun_ic"}),_vm._v(" "),_c('span',{staticClass:"post_return_fun_txt"},[_vm._v("回复")])])])],1)])])}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('span',{staticClass:"post_return_fun_ic_an"},[_c('i',{staticClass:"ic_praise_reply post_return_fun_ic"})])}]
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_babelrc_false_presets_babel_preset_react_app_plugins_transform_decorators_legacy_compact_true_cacheDirectory_false_highlightCode_true_node_modules_vue_loader_lib_selector_type_script_index_0_quickReplyCard_vue__ = __webpack_require__(54);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ef8b83e0_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_quickReplyCard_vue__ = __webpack_require__(149);
var normalizeComponent = __webpack_require__(10)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_babelrc_false_presets_babel_preset_react_app_plugins_transform_decorators_legacy_compact_true_cacheDirectory_false_highlightCode_true_node_modules_vue_loader_lib_selector_type_script_index_0_quickReplyCard_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ef8b83e0_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_quickReplyCard_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"post_return_row no_line",on:{"click":_vm.doReply}},[_c('div',{staticClass:"post_return_row_l"},[_c('figure',{staticClass:"post_return_row_img mini my"},[_c('img',{staticClass:"img_width i_bg",attrs:{"src":_vm.quickInfo.userImg}}),_vm._v(" "),_c('i',{staticClass:"post_return_row_ic"})])]),_vm._v(" "),_vm._m(0)])}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('aside',{staticClass:"post_return_row_r"},[_c('input',{staticClass:"post_return_row_ipt",attrs:{"type":"text","placeholder":"我的回复…","readonly":""}})])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_babelrc_false_presets_babel_preset_react_app_plugins_transform_decorators_legacy_compact_true_cacheDirectory_false_highlightCode_true_node_modules_vue_loader_lib_selector_type_script_index_0_loadmoreCard_vue__ = __webpack_require__(55);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_528493ba_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loadmoreCard_vue__ = __webpack_require__(151);
var normalizeComponent = __webpack_require__(10)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_babelrc_false_presets_babel_preset_react_app_plugins_transform_decorators_legacy_compact_true_cacheDirectory_false_highlightCode_true_node_modules_vue_loader_lib_selector_type_script_index_0_loadmoreCard_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_528493ba_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loadmoreCard_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"post_return_row",class:{'more_list': _vm.data.__singleLoadmore}},[_c('div',{staticClass:"post_return_row_l"}),_vm._v(" "),_c('aside',{staticClass:"post_return_row_r"},[_c('a',{staticClass:"post_return_more",class:{'hide': _vm.data.__showLoading},staticStyle:{"text-indent":"initial"},attrs:{"href":"javascript:void(0)"},on:{"click":_vm.doSecLoadmore}},[_vm._v("查看剩余"),_c('span',[_vm._v(_vm._s(_vm.data.__remainCount))]),_vm._v("条"+_vm._s(_vm.showCMNTName)+"...")]),_vm._v(" "),_c('a',{staticClass:"cm_loading",class:{'hide': !_vm.data.__showLoading}},[_c('img',{staticClass:"img_width",attrs:{"src":__webpack_require__(56)}}),_vm._v("加载中...")])])])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_babelrc_false_presets_babel_preset_react_app_plugins_transform_decorators_legacy_compact_true_cacheDirectory_false_highlightCode_true_node_modules_vue_loader_lib_selector_type_script_index_0_fakePubCard_vue__ = __webpack_require__(57);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_abcad196_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_fakePubCard_vue__ = __webpack_require__(153);
var normalizeComponent = __webpack_require__(10)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_babelrc_false_presets_babel_preset_react_app_plugins_transform_decorators_legacy_compact_true_cacheDirectory_false_highlightCode_true_node_modules_vue_loader_lib_selector_type_script_index_0_fakePubCard_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_abcad196_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_fakePubCard_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"post_return_row",class:{'no_line': !_vm.data.__hasLine}},[_c('div',{staticClass:"post_return_row_l"},[_c('figure',{staticClass:"post_return_row_img my",class:{'mini':_vm.data.__showMini}},[_c('img',{staticClass:"img_width i_bg",attrs:{"src":_vm.data.profile_img}}),_vm._v(" "),_c('i',{staticClass:"post_return_row_ic"})])]),_vm._v(" "),_c('aside',{staticClass:"post_return_row_r"},[_c('div',{staticClass:"post_return_com"},[_c('h2',{staticClass:"post_return_com_tit"},[_c('span',{staticClass:"post_return_com_tit_id"},[_vm._v(_vm._s(_vm.data.nick))]),_vm._v(" "),(_vm.data.tag)?_c('mark',{staticClass:"post_return_com_tit_sign"},[_vm._v(_vm._s(_vm.data.tag))]):_vm._e(),_vm._v(" "),(_vm.fakePublishText)?_c('span',{staticClass:"post_return_com_tit_state"},[_vm._v(_vm._s(_vm.fakePublishText))]):_vm._e()]),_vm._v(" "),_c('address',{staticClass:"post_return_add"},[_c('span',{staticClass:"post_return_add_txt"},[_vm._v(_vm._s(_vm.data.area))]),_vm._v(" "),_c('time',{attrs:{"calss":"post_return_add_t"}},[_vm._v(_vm._s(_vm.data.__showTime))])]),_vm._v(" "),_c('div',{class:{'post_return_show': !_vm.data.__showEllipsis}},[_c('p',{staticClass:"post_return_reply",domProps:{"innerHTML":_vm._s(_vm.data.__showContent)}}),_vm._v(" "),_c('a',{staticClass:"post_return_reply_more",on:{"click":_vm.doShowall}},[_vm._v("展开全部")]),_vm._v(" "),(_vm.data.comment_imgs && _vm.data.comment_imgs[0])?_c('img',{staticClass:"post_return_img i_bg",attrs:{"src":_vm.data.comment_imgs[0]},on:{"click":_vm.doImgclick}}):_vm._e()])])])])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return formatAllData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return showNumFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return mergeSecData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return addSecSpecData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return formatFakeData; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_xss_filters__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_xss_filters___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_xss_filters__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mfelibs_client_sticker_convert__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_toArray__ = __webpack_require__(158);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_toArray___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash_toArray__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_es6_set__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_es6_set___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_es6_set__);
function _objectWithoutProperties(obj,keys){var target={};for(var i in obj){if(keys.indexOf(i)>=0)continue;if(!Object.prototype.hasOwnProperty.call(obj,i))continue;target[i]=obj[i];}return target;}// ES6 Set polyfill
var showNumFormat=function showNumFormat(num){if(!num){return'';}if(num<=9999){return num+'人';}else if(num<=99999){return Math.round(num/1000)/10+'万人';}else if(num<=9990000){return Math.round(num/10000)+'万人';}else{return'999万+人';}};var addNormalShowData=function addNormalShowData(data,agreedList){var oriContentLen=__WEBPACK_IMPORTED_MODULE_2_lodash_toArray___default()(data.content).length;// 为了排除emoji的长度 emoji的长度可能为2或4 影响长度判断 lodash toArray方法处理了这种情况，绝大部分的单独的emoji可以被识别出来放在一个数组的元素中
var replaceObj=Object(__WEBPACK_IMPORTED_MODULE_1__mfelibs_client_sticker_convert__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0_xss_filters___default.a.inHTMLData(data.content));var cmntRealLen=oriContentLen+replaceObj.replaceNum-replaceObj.replaceLen;// 真实的评论字数 （一个表情 一个emoji算一个字）
// // 点赞信息 如果传有数组则为组件内判断。如果不传 默认为业务判断
// if (agreedList) {
if(agreedList.indexOf(data.mid)!=-1){data.__doPraise=1;}else{data.__doPraise=0;}// }
data.agree=parseInt(data.agree);data.__showContent=replaceObj.str;data.__type="normalCard";data.__hasLine=0;// 默认没有边框
data.__showReport=0;// 默认不举报
data.__showMini=0;// 默认是一级评论
data.__isMy=0;// 默认是其他人回复
data.__showTime=showTimeFormat(data.time);data.__showAgree=data.__showAgree?data.__showAgree:showNumFormat(data.agree);// 已赞
data.__hot=parseInt(data.agree,10)>49;// 热门评论 特殊背景颜色样式
// 保证加载更多新添加的元素不影响旧的
if(data.__showEllipsis==undefined){data.__showEllipsis=cmntRealLen>150;}};var formatAllData=function formatAllData(topLayer,secLayer,userInfo,agreedList){var midSet=new __WEBPACK_IMPORTED_MODULE_3_es6_set___default.a();var tempList=[];userInfo=userInfo||{};topLayer.forEach(function(topItem){// 去重
if(midSet.has(topItem.mid)){return;}else{midSet.add(topItem.mid);}addNormalShowData(topItem,agreedList);// 判断本人回复
if(topItem.uid===userInfo.uid){topItem.__isMy=1;}// 有快捷回复或者二级评论 则有边框
if(topItem.quick_reply){topItem.__hasLine=1;}tempList.push(topItem);// 有二级评论
if(secLayer[topItem.mid]){// 一级评论添加边线
tempList[tempList.length-1].__hasLine=1;var secNum=secLayer[topItem.mid].list&&secLayer[topItem.mid].list.length||0;if(userInfo.nick&&userInfo.uid){// 强制 登录后才可显示假发布
secLayer[topItem.mid].fakeList&&secLayer[topItem.mid].fakeList.forEach(function(fakeItem){formatFakeData(fakeItem,userInfo);// 添加 回复 xxx: 
if(fakeItem.parent_uid!==topItem.uid){// fakeItem.__showReplyUser = `回复${fakeItem.parent_nick}：`
fakeItem.__showContent='\u56DE\u590D'+fakeItem.parent_nick+'\uFF1A'+fakeItem.__showContent;}fakeItem.__showMini=1;secNum&&(fakeItem.__hasLine=1);tempList.push(fakeItem);});}secNum&&secLayer[topItem.mid].list.forEach(function(secItem,index){addNormalShowData(secItem,agreedList);secItem.__showMini=1;if(index==secNum-1){secItem.__hasLine=0;}else{secItem.__hasLine=1;}// 判断本人回复
if(secItem.uid===userInfo.uid){secItem.__isMy=1;}// 添加 回复 xxx: 
if(secItem.parent_uid!==topItem.uid){secItem.__showContent='\u56DE\u590D'+secItem.parent_nick+'\uFF1A'+secItem.__showContent;}tempList.push(secItem);});var totalSecLayerCount=secLayer[topItem.mid].count;if(totalSecLayerCount>secNum){// 显示加载更多时 前一个card需要添加边线
tempList[tempList.length-1].__hasLine=1;var loadmoreItem=Object.assign({},topItem,{__type:"loadmoreCard",__totalCount:totalSecLayerCount,__remainCount:totalSecLayerCount-secNum,__showLoading:secLayer[topItem.mid].__loading,__singleLoadmore:!topItem.quick_reply// 没有快捷回复时添加额外样式
});tempList.push(loadmoreItem);}}if(topItem.quick_reply){var quick_reply=topItem.quick_reply,cleanObj=_objectWithoutProperties(topItem,['quick_reply']);Object.assign(cleanObj,{__loginUserImg:userInfo.profile_img,// __loginUserId: userInfo.uid,
__type:"quickReplyCard"});tempList.push(cleanObj);}});return tempList;};var formatFakeData=function formatFakeData(data,userInfo){var oriContentLen=__WEBPACK_IMPORTED_MODULE_2_lodash_toArray___default()(data.content).length;// 为了排除emoji的长度 emoji的长度可能为2或4 影响长度判断 lodash toArray方法处理了这种情况，绝大部分的单独的emoji可以被识别出来放在一个数组的元素中
var replaceObj=Object(__WEBPACK_IMPORTED_MODULE_1__mfelibs_client_sticker_convert__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0_xss_filters___default.a.inHTMLData(data.content));var cmntRealLen=oriContentLen+replaceObj.replaceNum-replaceObj.replaceLen;// 真实的评论字数 （一个表情 一个emoji算一个字）
data.profile_img=userInfo.profile_img;data.nick=userInfo.nick;data.uid=userInfo.uid;data.__type="fakePubCard";data.__showContent=replaceObj.str;data.__showTime=showTimeFormat(data.time);// 保证加载更多新添加的元素不影响旧的
if(data.__showEllipsis==undefined){data.__showEllipsis=cmntRealLen>150;}};//三天以内用天，一天以内用具体时间，1小时以内用分钟，超过三天用日期
var showTimeFormat=function showTimeFormat(time){var DataTimer=void 0;if(time){var formateTime=time.replace(/-/g,'/');DataTimer=new Date(formateTime);}else{DataTimer=new Date();}var timeNum=+DataTimer;var now=+new Date();var duration=now-timeNum;var resultStr=time;if(duration>2592e5){// console.log('三天前' , new Date(timeNum).getMonth());
resultStr=DataTimer.getMonth()+1+'月'+DataTimer.getDate()+'日';}else if(duration>864e5){resultStr=Math.floor(duration/864e5)+'天前';}else if(duration>36e5){var status='今天 ';if(new Date().getDate()!=DataTimer.getDate()){status='昨天 ';}var minute=DataTimer.getMinutes();minute=(minute<10?'0':'')+minute;resultStr=status+DataTimer.getHours()+':'+minute;}else if(duration<0){return time;}else if(duration<=36e5){if(duration/1e3<60){// resultStr = Math.floor(duration / 1e3) + '秒钟前';
resultStr='刚刚';}else{resultStr=Math.floor(duration/6e4)+'分钟前';}}return resultStr;};// 添加二级评论特殊数据
// 页码 & loading状态
var addSecSpecData=function addSecSpecData(secObj){secObj.__loading=0;secObj.__page=1;};// isClick 0：表示随一级评论加载更多触发的二级评论更新 可能会同时更新多个mid
// isClick 1：表示手动触发的二级评论加载更多 一次只会更新一个mid 且需要修改loading的状态
var mergeSecData=function mergeSecData(oldData,newData,isClick){if(newData==null){return oldData;}var _loop=function _loop(key){var loadmoreFlag=0;// 本次是否有增量更新 下次请求二级评论加载更多 页码+1
if(oldData[key]){// 旧的二级评论数据中有对应的mid 
// 说明此次merge可能是二级评论的加载更多
// 需更新旧的二级评论数据
oldData[key]['count']=newData[key]['count'];// 空间换时间 避免两层forEach
var oldDataMap=new Map();oldData[key]['list'].forEach(function(oldItem){oldDataMap.set(oldItem.mid,oldItem);});newData[key]['list'].forEach(function(newItem){if(oldDataMap.has(newItem.mid)){// 直接修改旧数据 防止请求到的旧数据有修改（理论上不会出现有修改的情况）
Object.assign(oldDataMap.get(newItem.mid),newItem);}else{// 增量添加
oldData[key]['list'].push(newItem);loadmoreFlag=1;}});loadmoreFlag&&oldData[key].__page++;isClick&&(oldData[key].__loading=0);}else{oldData[key]=newData[key];addSecSpecData(oldData[key]);}};for(var key in newData){_loop(key);}return oldData;};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_index_css__ = __webpack_require__(157);
...
var cmntFace=["[→_→]","[呵呵]","[嘻嘻]","[哈哈]","[爱你]","[挖鼻屎]","[吃惊]","[晕]","[泪]","[馋嘴]","[抓狂]","[哼]","[可爱]","[怒]","[汗]","[害羞]","[睡觉]","[钱]","[偷笑]","[笑cry]","[doge]","[喵喵]","[二哈]","[酷]","[衰]","[闭嘴]","[鄙视]","[花心]","[鼓掌]","[悲伤]","[思考]","[生病]","[亲亲]","[怒骂]","[太开心]","[懒得理你]","[右哼哼]","[左哼哼]","[嘘]","[委屈]","[吐]","[可怜]","[打哈气]","[挤眼]","[失望]","[顶]","[疑问]","[困]","[感冒]","[拜拜]","[黑线]","[阴险]","[互粉]","[抱抱]","[摊手]","[心]","[伤心]","[猪头]","[熊猫]","[兔子]","[握手]","[作揖]","[赞]","[耶]","[good]","[弱]","[不要]","[ok]","[haha]","[来]","[威武]","[鲜花]","[钟]","[浮云]","[飞机]","[月亮]","[太阳]","[微风]","[下雨]","[给力]","[神马]","[围观]","[话筒]","[奥特曼]","[草泥马]","[萌]","[囧]","[织]","[礼物]","[喜]","[围脖]","[音乐]","[绿丝带]","[蛋糕]","[蜡烛]","[干杯]","[男孩儿]","[女孩儿]","[肥皂]","[照相机]","[浪]","[沙尘暴]"];/**
 * 返回过滤表情后的字符串 和 减去的长度
 * 为了更精确的计算原始评论长度
 * @param {String} content 
 * @param {Number} limit  限制的长度（从0开始，不传默认为不限制）
 * @return {Object} 返回替换后的评论内容HTML字符串(全部替换)(returnValue.str)、替换后的评论内容HTML字符串(截取)(returnValue.strLimit)、替换掉的表情数量(returnValue.replaceNum)、替换掉的字符串长度(returnValue.replaceLen)、替换的字符串长度（returnValue.addLen： <span class='....'></span>）
 */function replaceFace(content,limit){var data={str:'',strLimit:'',replaceNum:0,replaceLen:0,addLen:0// 替换后增加的距离。假设只有一个表情，一个表情在替换前默认算为1，替换后为变长，例如25。要求截取到第40位，则实际应截取到40-1+25位
};if(!/\[\/?[^\]]*]/g.test(content)){data.str=content;data.strLimit=content;if(limit){data.strLimit=content.substring(0,limit+1);}return data;}if(limit==null){limit=9007199254740992;}var offsetMark=0;// 标记需要截取的字段
var lastLess=0;// 上次进入替换函数时还缺少的字符串长度
var firstOverflow=0;// 当进入替换函数且超出字数限制时 只需再计算一次应截取的位置
data.str=content.replace(/\[\/?[^\]]*]/g,function(item,offset,oriStr){var curIndex=cmntFace.indexOf(item);if(curIndex<0){return item;}var outStr='<span class="faceList_'+parseInt(curIndex/28+1)+' face icon_'+curIndex%28+'"></span>';// 偏移 - 表情多计算的长度(data.replaceLen - data.replaceNum) < 限制
if(offset-(data.replaceLen-data.replaceNum)<=limit){lastLess=limit-(offset-(data.replaceLen-data.replaceNum));data.replaceNum=data.replaceNum+1;data.replaceLen=data.replaceLen+item.length;data.addLen=data.addLen+outStr.length;// 原位置 + 前方的(新表情长度- 原表情长度)；  -data.replaceLen中已把本次的减去了 要再加上  
offsetMark=offset+data.addLen-data.replaceLen+item.length;}else{if(!firstOverflow){offsetMark=offsetMark+lastLess;firstOverflow=1;}}return outStr;});// 针对情况 例如：  
// [表情]字字字字字字字字字 限制字数为4，最后一个匹配到的替换表情比这个数都小，所以需在外层再检测一次
if(!firstOverflow){offsetMark=offsetMark+lastLess;firstOverflow=1;}if(offsetMark==0){offsetMark=limit+1;}data.strLimit=data.str.substring(0,offsetMark);return data;}/* harmony default export */ __webpack_exports__["a"] = (replaceFace);
...
module.exports = __webpack_require__(171)() ? Set : __webpack_require__(172);
...
var clear          = __webpack_require__(58)
  , eIndexOf       = __webpack_require__(173)
  , setPrototypeOf = __webpack_require__(20)
  , callable       = __webpack_require__(2)
  , d              = __webpack_require__(7)
  , ee             = __webpack_require__(191)
  , Symbol         = __webpack_require__(4)
...
var numberIsNaN       = __webpack_require__(174)
...
var d              = __webpack_require__(7)
  , validateSymbol = __webpack_require__(194)
...
var isArguments    = __webpack_require__(21)
  , isString       = __webpack_require__(22)
  , ArrayIterator  = __webpack_require__(199)
  , StringIterator = __webpack_require__(209)
...
var copy             = __webpack_require__(201)
...
var aFrom  = __webpack_require__(202)
  , assign = __webpack_require__(31)
  , value  = __webpack_require__(1);
...
var objToString = Object.prototype.toString, id = objToString.call(__webpack_require__(59));
...
module.exports = __webpack_require__(208)("forEach");
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('aside',{staticClass:"post_return_case",on:{"click":function($event){_vm.hideReport($event)}}},[_vm._l((_vm.fakePublishList),function(item,index){return _c(_vm.cardTypeMap[item.__type],{key:item.__type + index,tag:"component",attrs:{"config":_vm.config,"data":item},on:{"do-showall":_vm.doShowall,"do-imgclick":_vm.doImgclick}})}),_vm._v(" "),_vm._l((_vm.cmntArray),function(item,index){return _c(_vm.cardTypeMap[item.__type],{key:index,tag:"component",attrs:{"data":item,"config":_vm.config},on:{"do-praise":_vm.doPraise,"do-reply":_vm.doReply,"do-report":_vm.doReport,"do-showall":_vm.doShowall,"do-imgclick":_vm.doImgclick,"do-sec-loadmore":_vm.doSecLoadmore,"show-report":_vm.showReport,"close-report":_vm.closeReport}})}),_vm._v(" "),(this.loadmoreThreshold)?_c('div',{staticClass:"cm_loading",class:{'hide': !_vm.topLoadmoreLock || _vm.noMoreCMNT}},[_c('img',{staticClass:"img_width",attrs:{"src":__webpack_require__(56)}}),_vm._v("加载中...\n  ")]):_vm._e()],2)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
